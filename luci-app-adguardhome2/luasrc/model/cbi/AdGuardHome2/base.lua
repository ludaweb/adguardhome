...
local configpath=uci:get("AdGuardHome2","AdGuardHome2","configpath") or "/etc/AdGuardHome2.yaml"
local binpath=uci:get("AdGuardHome2","AdGuardHome2","binpath") or "/usr/bin/AdGuardHome2/AdGuardHome2"
httpport=uci:get("AdGuardHome2","AdGuardHome2","httpport") or "3000"
m = Map("AdGuardHome2", "AdGuard Home")
m.description = translate("Free and open source, powerful network-wide ads & trackers blocking DNS server.")
m:section(SimpleSection).template  = "AdGuardHome2/AdGuardHome2_status"
...
o.datatype="port"
o.optional = false
o.description = translate("<input type=\"button\" style=\"width:210px;border-color:Teal; text-align:center;font-weight:bold;color:Green;\" value=\"AdGuardHome2 Web:"..httpport.."\" onclick=\"window.open('http://'+window.location.hostname+':"..httpport.."/')\"/>")
---- update warning not safe
local binmtime=uci:get("AdGuardHome2","AdGuardHome2","binmtime") or "0"
local e=""
...
if not fs.access(binpath) then
	...
	local version=uci:get("AdGuardHome2","AdGuardHome2","version")
	...
	if testtime~=tonumber(binmtime) or version==nil then
		...
		uci:set("AdGuardHome2","AdGuardHome2","version",version)
		uci:set("AdGuardHome2","AdGuardHome2","binmtime",testtime)
		uci:commit("AdGuardHome2")
	end
	e=version..e
end
o=s:option(Button,"restart",translate("Update"))
o.inputtitle=translate("Update core version")
o.template = "AdGuardHome2/AdGuardHome2_check"
...
---- Redirect
o = s:option(ListValue, "redirect", port..translate("Redirect"), translate("AdGuardHome2 redirect mode"))
o.placeholder = "none"
o:value("none", translate("none"))
o:value("dnsmasq-upstream", translate("Run as dnsmasq upstream server"))
o:value("redirect", translate("Redirect 53 port to AdGuardHome2"))
o:value("exchange", translate("Use port 53 replace dnsmasq"))
o.default     = "none"
o.optional = true
---- bin path
o = s:option(Value, "binpath", translate("Bin Path"), translate("AdGuardHome2 Bin path if no bin will auto download"))
o.default     = "/usr/bin/AdGuardHome2/AdGuardHome2"
o.datatype    = "string"
o.optional = false
o.rmempty=false
...
o.rmempty = true
---- config path
o = s:option(Value, "configpath", translate("Config Path"), translate("AdGuardHome2 config path"))
o.default     = "/etc/AdGuardHome2.yaml"
o.datatype    = "string"
o.optional = false
o.rmempty=false
o.validate=function(self, value)
...
---- work dir
o = s:option(Value, "workdir", translate("Work dir"), translate("AdGuardHome2 work dir include rules,audit log and database"))
o.default     = "/usr/bin/AdGuardHome2"
o.datatype    = "string"
o.optional = false
o.rmempty=false
o.validate=function(self, value)
...
---- log file
o = s:option(Value, "logfile", translate("Runtime log file"), translate("AdGuardHome2 runtime Log file if 'syslog': write to system log;if empty no log"))
o.datatype    = "string"
o.rmempty = true
o.validate=function(self, value)
if fs.stat(value,"type")=="dir" then
...
o.write=function()
	luci.sys.exec("sh /usr/share/AdGuardHome2/gfw2adg.sh del 2>&1")
	luci.http.redirect(luci.dispatcher.build_url("admin","services","AdGuardHome2"))
end
o=s:option(Button,"gfwadd",translate("Add gfwlist"),translate(a))
o.optional = true
o.inputtitle=translate("Add")
o.write=function()
	luci.sys.exec("sh /usr/share/AdGuardHome2/gfw2adg.sh 2>&1")
	luci.http.redirect(luci.dispatcher.build_url("admin","services","AdGuardHome2"))
end
if fs.access(configpath) then
...
o.inputtitle=translate("Del")
o.write=function()
	luci.sys.exec("sh /usr/share/AdGuardHome2/gfwipset2adg.sh del 2>&1")
	luci.http.redirect(luci.dispatcher.build_url("admin","services","AdGuardHome2"))
end
...
o.inputtitle=translate("Add")
o.write=function()
	luci.sys.exec("sh /usr/share/AdGuardHome2/gfwipset2adg.sh 2>&1")
	luci.http.redirect(luci.dispatcher.build_url("admin","services","AdGuardHome2"))
end
...
o.default     = ""
o.datatype    = "string"
o.template = "AdGuardHome2/AdGuardHome2_chpass"
o.optional = true
---- upgrade protect
...
local workdir=uci:get("AdGuardHome2","AdGuardHome2","workdir") or "/usr/bin/AdGuardHome2"
...
o1.default     = "/usr/bin/AdGuardHome2"
o1.datatype    = "string"
o1.optional = false
...
o.cfgvalue = function(self, section)
	return fs.readfile("/usr/share/AdGuardHome2/links.txt")
end
o.write = function(self, section, value)
	fs.writefile("/usr/share/AdGuardHome2/links.txt", value:gsub("\r\n", "\n"))
end
...
function m.on_commit(map)
	...
	elseif ucitracktest=="0" then
		...
		if (fs.access("/var/run/AdGlucitest")) then
			uci:set("AdGuardHome2","AdGuardHome2","ucitracktest","0")
			io.popen("/etc/init.d/AdGuardHome2 reload &")
		else
			fs.writefile("/var/run/AdGlucitest","")
			if (ucitracktest=="2") then
				uci:set("AdGuardHome2","AdGuardHome2","ucitracktest","1")
			else
				uci:set("AdGuardHome2","AdGuardHome2","ucitracktest","2")
			end
		end
		uci:commit("AdGuardHome2")
	end
